...
<head>
    ...
    <!--
不以/开头的相对路径，以当前路径的基准开始寻找
以/开头，找路径时，以服务器为标准(http:localhost:3306)需要加上项目名,所以可以在request域中加入app_path
-->
    <%
...
<script type="text/javascript">
    ...
    function build_page_info(result) {
        ...
        totalRecord = result.extend.pageInfo.total;//全局变量
        currentPage = result.extend.pageInfo.pageNum;//全局变量
    }
    ...
    function validate_add_form(){
        ...
        if(!regName.test(empName)){
            ...
            // alert("用户名规则：2~5位中文、6~16位英文、数字的纯文本或者组合");
            show_validate_msg("#empName_add_input","error","用户名规则：2~5位中文、6~16位英文、数字的纯文本或者组合");
